...
class Content extends \app\core\base\BaseActiveRecord
{
    ...
    {
        return [
            [['id', 'user_id', 'allow_comment', 'comments', 'views', 'diggs', 'burys', 'sticky', 'visibility', 'status', 'title', 'content', 'content_type', 'template'], 'required'],
            [['id', 'user_id', 'allow_comment', 'comments', 'views', 'diggs', 'burys', 'sticky', 'visibility', 'status'], 'integer'],
            [['created_at', 'modified_at'], 'safe'],
            [['content'], 'string'],
            [['password', 'content_type'], 'string', 'max' => 64],
            [['thumb', 'title', 'template'], 'string', 'max' => 255],
